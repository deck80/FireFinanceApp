<script lang="ts">
	...
	let cryptoAssets = $derived($assets.filter((a) => a.type === 'Crypto'));

	let totalCryptoValue = $derived(cryptoAssets.reduce((sum, a) => sum + a.value, 0));
...
<div class="crypto-page">
	<header>
		<div class="header-content">
			<div>
				<h1>Crypto Assets</h1>
				<p class="subtitle">Digital currencies and tokens</p>
			</div>
			<div class="header-actions">
				<div class="total-value">
					{formatMoney(totalCryptoValue, currency)}
				</div>
	...
	<div class="content-grid">
		<div class="list-section">
			<AssetList assets={cryptoAssets} {currency} onselect={(asset) => (selectedAsset = asset)} />
		</div>
