<script lang="ts">
	...
	let stockAssets = $derived($assets.filter((a) => a.type === 'Stock'));

	let totalStockValue = $derived(stockAssets.reduce((sum, a) => sum + a.value, 0));
...
<div class="stocks-page">
	<header>
		<div class="header-content">
			<div>
				...
				<p class="subtitle">Individual Companies</p>
			</div>
	...
	<div class="content-grid">
		<div class="list-section">
			<AssetList assets={stockAssets} {currency} onselect={(asset) => (selectedAsset = asset)} />
		</div>
